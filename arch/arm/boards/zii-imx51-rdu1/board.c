...
static int rdu1_init(void)
{
	...
	mc13xxx_register_init_callback(rdu1_power_init);
...
static int rdu1_xload_init_pinmux(void)
{
...
coredevice_initcall(rdu1_xload_init_pinmux);

static int rdu1_xload_init_devices(void)
{
...
device_initcall(rdu1_xload_init_devices);
