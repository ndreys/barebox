...
ENTRY_FUNCTION(start_zodiac_niu, r0, r1, r2)
{
	...
	fdt = __dtb_imx51_zodiac_niu_start - get_runtime_offset();
...
extern char __dtb_imx51_zodiac_mezz_start[];

ENTRY_FUNCTION(start_zodiac_mezz, r0, r1, r2)
{
	void *fdt;
	...
	fdt = __dtb_imx51_zodiac_mezz_start - get_runtime_offset();
