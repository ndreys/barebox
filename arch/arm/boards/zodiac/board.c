...
static void zodiac_power_init(struct mc13xxx *mc13xxx)
{
	u32 val;
...
coredevice_initcall(imx51_zodiac_xload_init_pinmux);

static int imx51_zodiac_xload_init_devices(void)
{
...
device_initcall(imx51_zodiac_xload_init_devices);
