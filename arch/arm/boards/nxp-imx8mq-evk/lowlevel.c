...
extern const u16 __ddr_phy_fw_lpddr4_pmu_train_1d_dmem_start[];
extern const u16 __ddr_phy_fw_lpddr4_pmu_train_1d_dmem_end[];
extern const u16 __ddr_phy_fw_lpddr4_pmu_train_1d_imem_start[];
extern const u16 __ddr_phy_fw_lpddr4_pmu_train_1d_imem_end[];

extern const u16 __ddr_phy_fw_lpddr4_pmu_train_2d_dmem_start[];
extern const u16 __ddr_phy_fw_lpddr4_pmu_train_2d_dmem_end[];
extern const u16 __ddr_phy_fw_lpddr4_pmu_train_2d_imem_start[];
extern const u16 __ddr_phy_fw_lpddr4_pmu_train_2d_imem_end[];
...
static void nxp_imx8mq_evk_sram_setup(void)
{
	...
	nxp_imx8mq_evk_init_ddr(
		DDRC_PHY_FIRMWARE(ddr_phy_fw_lpddr4_pmu_train_1d_imem),
		DDRC_PHY_FIRMWARE(ddr_phy_fw_lpddr4_pmu_train_1d_dmem),
		DDRC_PHY_FIRMWARE(ddr_phy_fw_lpddr4_pmu_train_2d_imem),
		DDRC_PHY_FIRMWARE(ddr_phy_fw_lpddr4_pmu_train_2d_dmem));
